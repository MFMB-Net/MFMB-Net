...
class MFMB_NET(nn.Module):
    ...
    def forward(self, text, audio, vision):
        ...
        #torch.Size([24, 50, 90]) torch.Size([24, 375, 90]) torch.Size([24, 500, 90]) torch.Size([24, 50, 90]) torch.Size([24, 375, 90]) torch.Size([24, 500, 90])
        #torch.Size([24, 50, 90]) torch.Size([24, 500, 90]) torch.Size([24, 500, 90]) torch.Size([24, 50, 90]) torch.Size([24, 500, 90]) torch.Size([24, 500, 90])
        ...
        if not self.args.without_generator:
            ...
            #torch.Size([24, 375, 5])
            #torch.Size([24, 500, 74])


            vision_ = self.generator_v(vision_h_g)

            #torch.Size([24, 500, 20])
            #torch.Size([24, 500, 35])
            ...
            #第fusion_complete 纯fusion没有reconstruction 把reconstruction的纳入fusion中的一个分支
